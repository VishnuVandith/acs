                ...
                <div className="card">
                    <div className="ms-Grid">
                        <div className="ms-Grid-row">
                            <h2 className="ms-Grid-col ms-lg6 ms-sm6 mb-4">Place a Call to Our Customer Support</h2>
                        ...
                        <div className="mb-2"> you are now ready to place calls and receive calls.</div>
                        {
                        ...
                        }
                        {
                            ...
                            <div className="ms-Grid-row mt-2" >
                                <div className="call-input-panel mb-5 ms-Grid-col ms-sm12 ms-lg12 ms-xl12 ms-xxl4">
                                    ...
                                    <div className="ms-Grid-row mb-2 mt-3">
                                        <div className="ms-Grid-co2 ms-lg6 ms-sm12">
                                            <TextField
                                                disabled={this.state.call || !this.state.loggedIn}
